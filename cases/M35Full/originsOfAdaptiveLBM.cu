	...
	for ( int iteration = 0; iteration < iterationCount; iteration++ )
	{
		if ( iteration % iterationChunk == 0 )
		{
			...
			if ( iteration >= 550000 )
			{
				...
				std::cout << "moving bounceback state of cell 2121190: " << movingBouncebackMarkerArrayCPU[ 2121190 ] << std::endl;		
				std::cout << "bounceback state of cell 2121190: " << bouncebackMarkerArrayCPU[ 2121190 ] << std::endl;				
